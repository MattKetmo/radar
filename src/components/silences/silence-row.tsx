...
export function SilenceRow({ silence }: { silence: Silence }) {
  return (
    <Link
      href={`?`}
    ...
    >
      ...
      <div className="text-sm max-w-[400px] font-medium truncate group-hover:text-blue-500 dark:group-hover:text-blue-300">
        {silence.comment}
      </div>
